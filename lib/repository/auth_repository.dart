import 'dart:convert';
import 'package:technoshop/models/data_model.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';

class AuthRepository {
  Future register(String phone,String name,String email, String password,String adr,String secteur,String description, String siteWeb) async{
    
    String baseUrl = '192.168.1.20';
    String register = 'flutter/pfebac/technoshopapi/public/api/register';
  ...
  //update user data
    ...
    Future signUp(String phone,String name,String email, String password) async{
  ...
  Future update(String token,String phone,String name,String email) async{
    ...
    String baseUrl = '192.168.1.20';
    String register = 'flutter/pfebac/technoshopapi/public/api/update';
  ...
  Future login(String email, String password) async {
    String baseUrl = '192.168.1.20';
    String login = 'flutter/pfebac/technoshopapi/public/api/login';
  ...
  Future getData(String token) async {
    //String baseUrl = "http://192.168.1.20:8000/api/user";
     ...
     String baseUrl = '192.168.1.20';
    String login = 'flutter/pfebac/technoshopapi/public/api/user';
