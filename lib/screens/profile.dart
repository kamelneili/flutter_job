              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left:55.0),
                      child: Text(state.user.phone.toString()),
                    ),
                  ],
                ),
                 SizedBox(
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(state.user.siteWeb.toString()),
                    ),
                  ],
                ),
                 SizedBox(
        ...
        Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(state.user.secteur.toString()),
                    ),
                  ],
                ),
                ...
                //
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(state.user.adr.toString()),
                    ),
                  ],
                ),
                //
                 SizedBox(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(state.user.description.toString()),
                    ),
                  ],
                ),
