...
class CartAPI {
  Future<Cart> fetchCart( String token) async {
    ...
    String cart = 'flutter/pfebac/technoshopapi/public/api/cart';
  ...
  Future<bool> addProductToCart(String offreId) async {
    String pId = offreId;
    // print(pId);
    String baseUrl = '192.168.1.20';
    String cart = 'flutter/pfebac/technoshopapi/public/api/cart';
...
//remove product from cart
  ...
  Future<bool> removeProductToCart(String productId) async {
    ...
    // print(pId);
    String baseUrl = '192.168.1.141';
    String cart = 'flutter/pfebac/technoshopapi/public/api/cart/remove';
    //   var token = data['data']['access_token'];
    SharedPreferences pref = await SharedPreferences.getInstance();
    String token = pref.getString('token');
    Uri uri = Uri.http(baseUrl, '$cart');
